...
# Creating a virtual environment and verifying it whether it is safe (https)
...
# Since we have 0-9 labels (10), we are using multi_class will be multinomial - which specifies to the computer that it is multinomeal logistic regression. 
# Classifier for training
# solver=saga means highly efficient
